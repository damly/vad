...
#define RTC_CHECK(condition)                                             \
  do {                                                                   \
    if (!(condition)) {                                                  \
/*      rtc_FatalMessage(__FILE__, __LINE__, "CHECK failed: " #condition);  //add by 8051263@qq.com*/ \
    }                                                                    \
  } while (0)
...
/*      rtc_FatalMessage(__FILE__, __LINE__, "DCHECK failed: " #condition);  //add by 8051263@qq.com */ \
    }                                                                     \
  } while (0)
